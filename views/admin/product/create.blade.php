        ...
        <form method="POST" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="" id="colour" class="form-control @error('colour') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea id="data_detail" class="form-control @error('data_detail') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea id="calls_detail"  class="form-control @error('calls_detail') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea id="sms_detail" class="form-control @error('sms_detail') is-invalid @enderror"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <textarea id="credit_validity_detail" class="form-control @error('credit_validity_detail') is-invalid @enderror"
