    ...
    <div class="card-body">
      <h4 class="card-title">{{ __('Update Product') }}</h4>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control @error('data_detail') is-invalid @enderror summernote "
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control @error('calls_detail') is-invalid @enderror summernote"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control @error('sms_detail') is-invalid @enderror summernote"
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control @error('credit_validity_detail') is-invalid @enderror summernote"
...
<!-- <link href="{{ asset('public/admin/user/css/summernote-bs4.min.css') }}" rel="stylesheet">  -->
