      ...
      <h4 class="card-title">{{ __('Update Product') }}</h4>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="color" class="form-control @error('colour') is-invalid @enderror"
                     value="{{ old('colour',$product->colour) }}" id="colour" name="colour" placeholder="your colour">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control @error('data') is-invalid @enderror"
                     value="{{ old('data',$product->data) }}" id="data" name="data" placeholder="your data">
        ...
        <div class="form-group row">
            <label
              for="data_detail"
              class="col-sm-3 text-end control-label col-form-label"
              ><b>{{ __('Data detail') }}</b></label>
            <div class="col-sm-9">
              <textarea class="form-control @error('data_detail') is-invalid @enderror"
                     value="" id="data_detail" name="data_detail" >{{ old('data_detail',$product->data_detail) }}</textarea>
        ...
        <div class="form-group row">
            <label
              for="calls_detail"
              class="col-sm-3 text-end control-label col-form-label"
              ><b>{{ __('Calls detail') }}</b></label>
            <div class="col-sm-9">
              <textarea class="form-control @error('calls_detail') is-invalid @enderror"
                      value="" id="calls_detail" name="calls_detail">{{ old('calls_detail',$product->calls_detail) }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control @error('sms') is-invalid @enderror"
                     value="{{ old('sms',$product->sms) }}" id="sms" name="sms" placeholder="your sms">
        ...
        <div class="form-group row">
            <label
              for="sms_detail"
              class="col-sm-3 text-end control-label col-form-label"
              ><b>{{ __('SMS detail') }}</b></label>
            <div class="col-sm-9">
              <textarea class="form-control @error('sms_detail') is-invalid @enderror"
                     value="" id="sms_detail" name="sms_detail" >{{ old('sms_detail',$product->sms_detail) }}</textarea>
        ...
        <div class="form-group row">
            <label
              for="credit_validity"
              class="col-sm-3 text-end control-label col-form-label"
              ><b>{{ __('Credit validity') }}</b></label>
            <div class="col-sm-9">
              <input type="text" class="form-control @error('credit_validity') is-invalid @enderror"
                     value="{{ old('credit_validity',$product->credit_validity) }}" id="credit_validity" name="credit_validity" >
        ...
        <div class="form-group row">
            <label
              for="credit_validity_detail"
              class="col-sm-3 text-end control-label col-form-label"
              ><b>{{ __('Credit validity detail') }}</b></label>
            <div class="col-sm-9">
              <textarea class="form-control @error('credit_validity_detail') is-invalid @enderror"
                     value="" id="credit_validity_detail" name="credit_validity_detail" >{{ old('credit_validity_detail',$product->credit_validity_detail) }}</textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
              <textarea class="form-control @error('description')is-invalid @enderror"
                      value="" id="description" name="description" placeholder="name@example.com">{{ old('description',$product->description) }}</textarea>
            ...
            <div class="col-sm-9">
                ...
                <div class="prod_feature">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="title[]" class="form-control title" id="title" value="{{ old('title',$feature->title) }}" required>
                        </div>
                        <div class="col-sm-1">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="add_description[]" id="add_description">{{ old('add_description',$feature->description) }}</textarea>
                        </div>
                    </div>
                </div>
                @endforeach
    ...
    function addrow()
    {
        ...
        '<div class="prod_feature">'+
            ...
            '<div class="form-group row">'+
                ...
                '<div class="col-sm-8">' +
                    '<textarea class="form-control" name="add_description[]" id="add_description">{{ old('add_description') }}</textarea>' +
                '</div>' +
            '</div>'+
        '</div>';
